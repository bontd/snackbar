...
export interface SharedProps<V extends VariantType = VariantType> extends Partial<TransitionHandlerProps> {
   ...
   * https://opensource.focela.com/snackbar/examples/advanced/custom-transition
   * @default Slide
   */
...
/**
 * Properties of a snackbar internal to snackbar implementation. Not to be used by outside
...
export declare const SnackbarContent: (props: SnackbarContentProps & React.RefAttributes<HTMLDivElement>) => React.ReactElement<any, any>;
