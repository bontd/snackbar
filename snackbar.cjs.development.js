...
var _excluded = ["children", "in", "mountOnEnter", "unmountOnExit", "appear", "enter", "exit", "timeout", "addEndListener", "onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "nodeRef"];
...
var _excluded$1 = ["children", "direction", "in", "style", "timeout", "onEnter", "onEntered", "onExit", "onExited"];
...
var CheckIcon = function CheckIcon() {
  return /*#__PURE__*/React__default.createElement(SvgIcon, null, /*#__PURE__*/React__default.createElement("path", {
...
var ComponentClasses = {
  ...
  MuiContentVariant: function MuiContentVariant(variant) {
    return "snackbar-MuiContent-" + variant;
  }
};
...
var ariaDescribedby = 'snackbar-snackbar';
var MaterialDesignContent = /*#__PURE__*/React.forwardRef(function (props, forwardedRef) {
  ...
  return /*#__PURE__*/React__default.createElement(SnackbarContent, {
    ref: forwardedRef,
    role: "alert",
  ...
  }, !hideIconVariant ? icon : null, message), action && /*#__PURE__*/React__default.createElement("div", {
...
var _excluded$3 = ["open", "SnackbarProps", "TransitionComponent", "TransitionProps", "transitionDuration", "disableWindowBlurListener", "content", "entered", "requestClose", "onEnter", "onEntered", "onExit", "onExited"];
...
var SnackbarItem = function SnackbarItem(props) {
  ...
  var open = snack.open,
    ...
    otherSnack = _objectWithoutPropertiesLoose(snack, _excluded$3);
  ...
  return /*#__PURE__*/React__default.createElement(Collapse, {
    ...
    onClose: handleClose
  }, /*#__PURE__*/React__default.createElement(TransitionComponent, Object.assign({}, transitionProps, {
    appear: true,
    "in": open,
  ...
  }), content || /*#__PURE__*/React__default.createElement(Component, Object.assign({}, otherSnack)))));
};
...
var SnackbarContainer = function SnackbarContainer(props) {
  ...
  var combinedClassname = clsx(ComponentClasses.SnackbarContainer, styles$1[anchorOrigin.vertical], styles$1[anchorOrigin.horizontal], styles$1.root,
...
/* eslint-disable */
var messages = {
  NO_PERSIST_ALL: "Reached maxSnack while all enqueued snackbars have 'persist' flag. Snackbar will dismiss the oldest snackbar anyway to allow other ones in the queue to be presented."
};
...
var isOptions = function isOptions(messageOrOptions) {
  var isMessage = typeof messageOrOptions === 'string' || /*#__PURE__*/React.isValidElement(messageOrOptions);
  return !isMessage;
};
var SnackbarProvider = /*#__PURE__*/function (_Component) {
  function SnackbarProvider(props) {
    ...
    _this.enqueueSnackbar = function (messageOrOptions, optsOrUndefined) {
      ...
      var key = opts.key,
        ...
        options = _objectWithoutPropertiesLoose(opts, _excluded$4);
  ...
  _proto.render = function render() {
    ...
    var snackbars = Object.keys(categ).map(function (origin) {
      ...
      return /*#__PURE__*/React__default.createElement(SnackbarContainer$1, {
        ...
        return /*#__PURE__*/React__default.createElement(SnackbarItem, {
          key: snack.id,
          snack: snack,
          classes: classes,
  ...
  return _createClass(SnackbarProvider, [{
    key: "maxSnack",
    get: function get() {
...
//# sourceMappingURL=snackbar.cjs.development.js.map
